...
public class NeedOld {
    ...
    public void setCategory(String category) {
        if (NeedOld.CATEGORY_NAMES.containsKey(category)) {
            this.mCategory = NeedOld.CATEGORY_NAMES.get(category);
        } else {
    ...
    public NeedOld fromJSON(Context context, JSONObject obj) throws JSONException, IOException, ParseException {
        NeedOld need = new NeedOld();
    ...
    public NeedOld fromIntent(Intent intent) {
        NeedOld need = new NeedOld();
